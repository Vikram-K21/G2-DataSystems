...
def main():
    ...
    st.write("""
    This dashboard analyses the relationship between electric vehicle adoption, 
    ...
    with tab2:
        ...
        if not suburb_data.empty:
            ...
            fig.add_trace(
                go.Bar(
                    ...
                    marker_color='#2196F3',
                    width=0.3  # Adjust width to make bars skinnier
                ),
                secondary_y=False
            )
        ...
        fig.update_layout(
            ...
            height=500,
            bargap=0.5  # Adjust the gap between bars (optional)
        )
